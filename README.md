...
.venv/bin/python main.py bench --in-file запись.mp3 --profile small --budget 10
```
...
Замер на dev-машине (RTX 2070 + Ryzen 9950X3D), профиль `vram5` с `--rvc`:
...
|---|---|---|---|
| `vram5` | `large-v3-turbo` | 1231 МБ | дачная машина, Quadro P2000 (5 ГБ) |
| `vram10` | `large-v3` | 2027 МБ | домашний сервер, P102-100 (10 ГБ) |
