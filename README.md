...
| длинная передача с текстом в пару слов, быстрее 30 симв/с | 5 | 4 из 1978 |

Итого отсеивается 1409 фраз из 1978 и **365 ответов в шум из 695**.
...
Правило «слишком медленно» (`min_chars_per_s`) по умолчанию **выключено**: на данных
оно резало живые «Да», «Угу», «Федька, привет» — короткие реплики на длинной записи.
